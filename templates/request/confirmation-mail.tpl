Hello! You, or a user from {$ip} has requested an account on the English Wikipedia ( https://en.wikipedia.org ).

Please go to {$baseurl}/index.php/confirmEmail?si={$hash}&id={$id} in order to complete this request.
