	...
	<div class="span12">
		<form class="form-horizontal" method="post">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="inputName" name="ename" value="{$ename}">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="input-xxlarge" id="inputText" rows="20" name="etext">{$etext}</textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xxlarge" id="inputQuestion" name="equestion" size="75" value="{$equestion}">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="checkbox" id="inputCreated" name="ecreated"{if $ecreated == true}checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="inputActive">Is this template enabled?</label>
				<div class="controls">
					<input type="checkbox" id="inputActive" name="eactive"{if $eactive == 1}checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
