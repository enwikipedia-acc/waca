	...
	<div class="span12">
		<form class="form-horizontal" method="post">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="inputName" name="name" value="{$name}"{if !$currentUser->isAdmin()} disabled{/if}>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="input-xxlarge" id="inputText" rows="20" name="text"{if !$currentUser->isAdmin()} disabled{/if}>{$text}</textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xxlarge" id="inputQuestion" name="jsquestion" size="75" value="{$jsquestion}" {if !$currentUser->isAdmin()} disabled{/if}>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="checkbox"  id="inputCreated" name="oncreated"{if !$currentUser->isAdmin() || $id == $createdid} disabled{/if}{if $oncreated} checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="inputActive">Is this template enabled?</label>
				<div class="controls">
					<input type="checkbox" id="inputActive" name="active"{if !$currentUser->isAdmin() || $id == $createdid} disabled{/if}{if $active} checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
