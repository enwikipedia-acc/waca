	...
	<div class="span12">
		<form class="form-horizontal" method="post">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="inputName" name="ename" value="{$ename}"{if $userisadmin == false || $id == $createdid} disabled{/if}>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="checkbox"  id="inputCreated" name="ecreated"{if $userisadmin == false || $id == $createdid} disabled{/if}{if $ecreated == true} checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="inputActive">Is this template enabled?</label>
				<div class="controls">
					<input type="checkbox" id="inputActive" name="eactive"{if $userisadmin == false || $id == $createdid} disabled{/if}{if $eactive == 1} checked{/if}>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
