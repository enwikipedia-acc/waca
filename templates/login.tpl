	...
	<div class="offset4 span4 well">
		...
		<form class="container-fluid" action="{$tsurl}/acc.php?action=login&amp;nocheck=1" method="post">
			<div class="control-group row">
				<input type="text" id="username" name="username" placeholder="Username" {if isset($smarty.get.tplUsername)} value="{$smarty.get.tplUsername|escape}"{/if} class="offset2 span8" required>
			</div>
			<div class="control-group row">
