{include file="offline/header-internal.tpl"}
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <div class="page-header"><h1>Whoops!</h1></div>
            ...
            <p>Once the identity of the culprit(s) is known, trout should be applied here: <b>{$dontUseDbCulprit}</b></p>
