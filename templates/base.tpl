...
<head>
    ...
    <!-- bootstrap styles -->
    <link href="{$baseurl}/resources/generated/{$skinBaseline|default:'bootstrap4'}-{$skin|escape|default:'auto'}.css?{$resourceCacheEpoch}" rel="stylesheet"/>
...
{block name="footerjs"}
    ...
    <script src="{$baseurl}/node_modules/{$skinBaseline|default:'bootstrap4'}/dist/js/bootstrap.min.js" type="text/javascript"></script>
