<div class="linkWrapSection">
    ...
    <a id="IPActiveLocalBlock-{$index}" class="btn btn-small" target="_blank"
       href="https://en.wikipedia.org/wiki/Special:BlockList/{$ipaddress}"
       onMouseUp="$('#IPActiveLocalBlock-{$index}').addClass('btn-visited');">
        Active Local Blocks
    </a>
    <a id="IPGlobalBlockLog-{$index}" class="btn btn-small" target="_blank"
    ...
    <a id="IPActiveGlobalBlock-{$index}" class="btn btn-small" target="_blank"
    ...
    <a id="IPHoneypot-{$index}" class="btn btn-small" target="_blank"
       href="{$baseurl}/redir.php?tool=honeypot&amp;data={$ipaddress}"
       onMouseUp="$('#IPHoneypot-{$index}').addClass('btn-visited');">
        Project Honeypot
    </a>
    <a id="IPStopForumSpam-{$index}" class="btn btn-small" target="_blank"
       href="{$baseurl}/redir.php?tool=stopforumspam&amp;data={$ipaddress}"
       onMouseUp="$('#IPStopForumSpam-{$index}').addClass('btn-visited');">
        StopForumSpam
    </a>
    ...
    <a id="BGPView-{$index}" class="btn btn-small" target="_blank"
       href="{$baseurl}/redir.php?tool=bgpview&amp;data={$ipaddress}"
       onMouseUp="$('#BGPView-{$index}').addClass('btn-visited');">
        BGP Prefixes
    </a>
    {if $canSeeCheckuserData}
        <div class="btn-group">
            <a id="IPCU-{$index}" class="btn btn-small" target="_blank"
               ...
               onMouseUp="$('#IPCU-{$index}').addClass('btn-visited');">CheckUser</a>
            <a id="IPCULog-{$index}" class="btn btn-small" target="_blank"
               href="https://en.wikipedia.org/wiki/Special:CheckUserLog?cuSearchType=target&amp;cuSearch={$ipaddress}"
               onMouseUp="$('#IPCULog-{$index}').addClass('btn-visited');">CU Log</a>
        </div>
        <div class="btn-group">
            <a id="IPLWCU-{$index}" class="btn btn-small" target="_blank"
               ...
               onMouseUp="$('#IPLWCU-{$index}').addClass('btn-visited');">LW CU</a>
            <a id="IPLWCULog-{$index}" class="btn btn-small" target="_blank"
               href="https://login.wikimedia.org/wiki/Special:CheckUserLog?cuSearchType=target&amp;cuSearch={$ipaddress}"
               onMouseUp="$('#IPLWCULog-{$index}').addClass('btn-visited');">Log</a>
        </div>
    {/if}
</div>
