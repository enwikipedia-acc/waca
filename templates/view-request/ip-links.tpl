<div class="linkWrapSection">
    ...
    <a id="IPActiveLocalBlock-{$index}" class="btn btn-sm btn-light" target="_blank"
       href="https://en.wikipedia.org/wiki/Special:BlockList/{$ipaddress}"
       onMouseUp="$('#IPActiveLocalBlock-{$index}').addClass('btn-visited');">
        Active Local Blocks
    </a>
    <a id="IPGlobalBlockLog-{$index}" class="btn btn-sm btn-light" target="_blank"
    ...
    <a id="IPActiveGlobalBlock-{$index}" class="btn btn-sm btn-light" target="_blank"
    ...
    {if $canSeeCheckuserData}
        <a id="IPCU-{$index}" class="btn btn-sm btn-light" target="_blank"
        ...
        <a id="IPCULog-{$index}" class="btn btn-sm btn-light" target="_blank"
