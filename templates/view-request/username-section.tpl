...
<div class="linkWrapSection">
    <a id="UsernameUserPage" class="btn btn-sm btn-light" target="_blank"
       href="https://en.wikipedia.org/wiki/User:{$requestName|escape:'url'}"
       onMouseUp="$('#UsernameUserPage').addClass('btn-visited');">
        User page
    </a>
    <a id="UsernameCreationLog" class="btn btn-sm btn-light" target="_blank"
    ...
    <a id="UsernameSUL" class="btn btn-sm btn-light" target="_blank"
       href="{$baseurl}/redir.php?tool=sulutil&amp;data={$requestName|escape:'url'}"
       onMouseUp="$('#UsernameSUL').addClass('btn-visited');">
        SUL
    </a>
    <a id="UsernameCentralAuth" class="btn btn-sm btn-light" target="_blank"
    ...
    <a id="UsernameUsernameList" class="btn btn-sm btn-light" target="_blank"
    ...
    <a id="UsernameMainspaceSearch" class="btn btn-sm btn-light" target="_blank"
    ...
    <a id="UsernameGoogleSearch" class="btn btn-sm btn-light" target="_blank"
