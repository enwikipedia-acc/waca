                ...
                <tr>
                    ...
                    <td>
                        <h3>Note: This account has already been created
                            <a id="SpoofPassReset-{$spoof@iteration}" class="btn btn-sm" target="_blank"
            ...
            <tr>
                ...
                <td>
                    <div class="linkWrapSection">
                        <a id="SpoofContribs-{$spoof@iteration}" class="btn btn-sm" target="_blank"
                        ...
                        <a id="SpoofLogs-{$spoof@iteration}" class="btn btn-sm" target="_blank"
                        ...
                        <a id="SpoofSUL-{$spoof@iteration}" class="btn btn-sm" target="_blank"
                           href="{$baseurl}/redir.php?tool=sulutil&amp;data={$spoof|escape:'url'}"
                           onMouseUp="$('#SpoofSUL-{$spoof@iteration}').addClass('btn-visited');">
                            SUL
                        </a>
                        <a id="SpoofCentralAuth-{$spoof@iteration}" class="btn btn-sm" target="_blank"
                        ...
                        <a id="SpoofCount-{$spoof@iteration}" class="btn btn-sm" target="_blank"
