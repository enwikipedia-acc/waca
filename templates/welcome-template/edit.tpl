    ...
    <div class="row-fluid">
        ...
        <form method="post" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xxlarge" name="usercode" id="usercode" value="{$template->getUserCode()|escape}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea class="input-xxlarge" rows="10" name="botcode" id="botcode">{$template->getBotCode()|escape}</textarea>
