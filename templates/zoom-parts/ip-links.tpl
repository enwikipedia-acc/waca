...
<div class="linkWrapSection">
  ...
  <a id="IPGUC-{$index}" class="btn btn-small" target="_blank" href="{$baseurl}/redir.php?tool=guc&amp;data={$ipaddress}" onMouseUp="$('#IPGUC-{$index}').addClass('btn-visited');">Global Contribs (GUC)</a>
