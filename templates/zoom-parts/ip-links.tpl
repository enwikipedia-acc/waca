...
<div class="linkWrapSection">
  ...
  <a id="IPGlobalContribs-{$index}" class="btn btn-small" target="_blank" href="{$baseurl}/redir.php?tool=luxo-contributions&amp;data={$ipaddress}" onMouseUp="$('#IPGlobalContribs-{$index}').addClass('btn-visited');">Global Contributions</a>
