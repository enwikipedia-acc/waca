...
<head>
    ...
    <!-- Le styles -->
    <link href="{$baseurl}/resources/generated/public4.css" rel="stylesheet"/>
</head>
...
{block name="footerjs"}
    ...
    <script src="{$baseurl}/node_modules/bootstrap4/dist/js/bootstrap.min.js" type="text/javascript"></script>
{/block}
</body>
</html>
