...
CREATE PROCEDURE SCHEMA_UPGRADE_SCRIPT() BEGIN
    ...
    -- -------------------------------------------------------------------------
    DECLARE patchversion INT DEFAULT 42;
    -- -------------------------------------------------------------------------
    -- working variables
    ...
    ALTER TABLE domain
        CHANGE emailsender emailreplyaddress VARCHAR(255) NOT NULL COMMENT 'the from/sender address of the mailing list, for users to reply with';
