...
class StatsUsers extends StatisticsPage
{
	...
	function getUserDetail($userId)
	{
		...
		$qb = new QueryBrowser();
		$out .= $qb->executeQueryToTable('SELECT mail_desc AS "Close type", COUNT(*) AS Count FROM p_acc_live.acc_log l INNER JOIN closes ON `CONCAT("Closed ",mail_id)` = l.log_action WHERE l.log_user = "'.$siuser.'" AND l.log_action LIKE "Closed%" GROUP BY l.log_action;');
