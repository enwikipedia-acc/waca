...
function listrequests($type, $hideip) {
	...
	*/
	...
	$reqlist = '';
	$currentreq = 0;
	while ( list( $pend_id, $pend_email, $pend_ip, $pend_name, $pend_cmt, $pend_status, $pend_date, $pend_checksum, $pend_emailsent, $pend_mailconfirmed ) = mysql_fetch_row( $result ) ) {
		$currentreq += 1;
		...
		if ( $row4['user_secure'] > 0 ) {
			...
			// Username U:
			$duname = _utf8_decode($pend_name);
			$out .= '</span> ] </small></td><td><small><a class="request-req" href="http://en.wikipedia.org/wiki/User:' . $uname . '" target="_blank"><strong>' . $duname . '</strong></a> ';
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	...
	<body id="body">
		...
		<div id="content">
			<h1>Internal Account Creation interface</h1>
			<h2>Apologies!</h2>
			...
			<p>However, users can still request accounts by emailing <a href="https://lists.wikimedia.org/mailman/listinfo/accounts-enwiki-l">accounts-enwiki-l@lists.wikimedia.org</a>, so please keep an eye on the mailing list.</p>
			<p>For more information about the downtime, please <a href="irc://irc.freenode.net/#wikipedia-en-accounts">join IRC</a> or check the mailing list.</p>
		</div>
		<div id="footer">
