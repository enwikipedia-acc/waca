...
function showIPlinks($ip, $wikipediaurl, $metaurl, $rqid) {
	...
	// CheckUser links
	 $out .= '| ';
	 $out .= '<a class="request-src" href="https://fastlizard4.org/w/index.php?title=Special:CheckUser&ip=' . $ip . '&reason=%5B%5BWP:ACC%5D%5D request %23' . $rqid . '" target="_blank">CheckUser</a> ';
	 $out .= '</p>';
