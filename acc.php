...
<option value="mattc">{{subst:User:Matt.T/C}} ~~~~</option></select>
...
?>
    ...
    <option value="mattc"<?php if($template == "mattc") { echo " selected=\"selected\""; } ?>>{{subst:User:Matt.T/C}} ~~~~</option>
