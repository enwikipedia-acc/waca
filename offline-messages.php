...
function showOfflineMessageHeader()
{
	echo <<<HTML
...
function showOfflineMessageFooter()
{
	echo <<<HTML
		</div>
		<div id="footer">
...
function showInternalOfflineMessage($offlineProblem, $offlineCulprit)
{
	showOfflineMessageHeader();
	echo <<<HTML
<h2>Whoops!</h2>
...
HTML;
	showOfflineMessageFooter();
}

function showExternalOfflineMessage()
{
	showOfflineMessageHeader();
	echo <<<HTML
