...
if (mysql_num_rows($result) != 0){
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		$out = "<li><small>[ <span class=\"request-ban\">$uname</span> / <a class=\"request-src\" href=\"$wikiurl/wiki/User:$uoname\">$uoname</a> ]";
		$out .= " <a class=\"request-req\" href=\"$tsurl/users.php?approve=$userid\" onclick=\"return confirm('Are you sure you wish to approve $uname?')\">Approve!</a> - <a class=\"request-req\" href=\"$tsurl/users.php?decline=$userid\">Decline</a> - <a class=\"request-req\" href=\"http://toolserver.org/~soxred93/pcount/index.php?name=$uoname&amp;lang=en&amp;wiki=wikipedia\">Count!</a>";
		$out .=" - <a class=\"request-req\" href=\"http://$wikiurl/w/index.php?oldid=$conf_revid\">Confirmation diff</a></small></li>";
		echo "$out\n";
	}
	echo "</ol>\n";
}
